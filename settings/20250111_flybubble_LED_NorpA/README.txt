...
20250111 
merged 20240912_flybubble_socialCsChr and 20210806_flybubble_LED_NorpA to make update settings for reprocessing flybubble_social movies
added nottracking_aptv4.jab flytracker based classifer that uses APT features - should use judicially, feature size will be large
